...
/* This is the prescaler used by the clock that generates RTOS ticks. */
#define portCLOCK_PRESCALER	1
...
// This needs to be defined so that 32-bit integers will be printed as 32-bit
// integers, not 16 bit integers
